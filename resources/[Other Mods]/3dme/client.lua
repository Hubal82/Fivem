-- Settings
local color = { r = 255, g = 0, b = 135, alpha = 255 } -- Color of the text 
local font = 1 -- Font of the text
local time = 14000 -- Duration of the display of the text : 1000ms = 1sec
local background = {
    enable = false,
...
function DrawText3D(x,y,z, text)
    ...
    if onScreen then
        ...
        SetTextScale(0.0*scale, 0.98*scale)
        SetTextFont(font)
