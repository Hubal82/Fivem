--
lockState = {    
    [1] = { ["objName"] = "v_ilev_tort_door", ["x"]= 134.395, ["y"]= -2204.097, ["z"]= 7.514, ["locked"]= true }, -- torture door at pier
}
--
...
--
RegisterNetEvent('iamcat6:frstate')
AddEventHandler('iamcat6:frstate', function(id, isLocked)
        ...
        for i=1, #lockState do
                ...
                if(distance < 1.25) then
                    ...
                    if IsControlJustPressed(1,51) then
                        if lockState[i]["locked"] == true then
                            TriggerServerEvent('iamcat6:frupdateState', i, false) -- ask the server to update states... dont just DO it.
                        else
                            TriggerServerEvent('iamcat6:frupdateState', i, true)
                        end                        
                    end
