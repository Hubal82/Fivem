...
--    if ( IsControlJustReleased( 0, 19 ) or IsDisabledControlJustReleased( 0, 19 ) and IsControlJustReleased( 0, 288 ) or IsDisabledControlJustReleased( 0, 288 )  ) and GetLastInputMethod( 2 ) then
      TooglePhone()
    end
...
RegisterNUICallback('reponseText', function(data, cb)
  local limit = data.limit or 5000
