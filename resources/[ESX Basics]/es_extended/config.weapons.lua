Config.Weapons = {
...

	{
		...
		label = _U('weapon_pistolmk2'),
		components = {}
	},
	{
		name = 'WEAPON_SPECIALCARBINE_MK2',
		label = _U('weapon_specialcarbinemk2'),
		components = {}
	},
	{
		name = 'WEAPON_BULLPUPRIFLE_MK2',
		label = _U('weapon_bullpupriflemk2'),
		components = {}
	},
	{
		name = 'WEAPON_PUMPSHOTGUN_MK2',
		label = _U('weapon_pumpshotgunmk2'),
		components = {}
	},
	{
		name = 'WEAPON_MARKSMANRIFLE_MK2',
		label = _U('weapon_marksmanriflemk2'),
		components = {}
	},
	{
		name = 'WEAPON_SMG_MK2',
	...
	},
	{
		...
		label = _U('weapon_heavyrevolvermk2'),
		components = {}
	},
	{
		name = 'WEAPON_CARBINERIFLE_MK2',
		label = _U('weapon_carbineriflemk2'),
		components = {}
	},
	{
		name = 'WEAPON_COMBATMG_MK2',
		label = _U('weapon_combatmgmk2'),
		components = {}
	},
