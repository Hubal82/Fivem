...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	ESX.TriggerServerCallback('esx:getPlayerData', function(xdata)
		local data = xdata
		...
		ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
			SendNUIMessage({action = "setValue", key = "societyaccount", value = "$".. money})
		end, job.label)
	end)
end)
...
AddEventHandler('adrp_ui:updateWeight', function(weight)
