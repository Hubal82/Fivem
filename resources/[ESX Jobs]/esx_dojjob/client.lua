local takeJob = {x=111.71,y=-757.25,z=44.25}
local bossUI = {x=116.89,y=-751.39,z=44.75}
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  if(PlayerData.job.grade_name == "boss" and PlayerData.job.name == "doj") then
  	createSocietyMenu(bossUI.x,bossUI.y,bossUI.z,"doj", "Doj")
  end
end)
