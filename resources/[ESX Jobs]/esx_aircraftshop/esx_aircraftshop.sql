...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('aircraftdealer', 0, 'soldato', 'Rookie', 2800, '{}', '{}'),
	('aircraftdealer', 1, 'capo', 'Security', 3100, '{}', '{}'),
	('aircraftdealer', 2, 'consigliere', 'Transporter', 3300, '{}', '{}'),
	('aircraftdealer', 3, 'consigliere', 'R&D', 3700, '{}', '{}'),
	('aircraftdealer', 4, 'boss', 'CFO', 4000, '{}', '{}'),
	('aircraftdealer', 5, 'boss', 'CEO', 4500, '{}', '{}')
;
