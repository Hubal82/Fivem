...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'whiskey', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'whiskey', _U('whiskey_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'whiskey', 'Whiskey', 'society_whiskey', 'society_whiskey', 'society_whiskey', {type = 'private'})



RegisterServerEvent('esx_whiskeyjob:getStockItem')
AddEventHandler('esx_whiskeyjob:getStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_whiskey', function(inventory)
...
ESX.RegisterServerCallback('esx_whiskeyjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_whiskeyjob:putStockItems')
AddEventHandler('esx_whiskeyjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_whiskeyjob:getFridgeStockItem')
AddEventHandler('esx_whiskeyjob:getFridgeStockItem', function(itemName, count)

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_whiskey_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_whiskeyjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_whiskeyjob:putFridgeStockItems')
AddEventHandler('esx_whiskeyjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_whiskeyjob:buyItem')
AddEventHandler('esx_whiskeyjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_whiskey', function(account)
...
RegisterServerEvent('esx_whiskeyjob:craftingCoktails')
AddEventHandler('esx_whiskeyjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_whiskeyjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_whiskey', function(store)
...
ESX.RegisterServerCallback('esx_whiskeyjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_whiskeyjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_whiskeyjob:getPlayerInventory', function(source, cb)
