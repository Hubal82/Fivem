...
function OpenCloakroomMenu()
	...
	elseif grade == 'intendent' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'intendent_wear'})
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'lieutenant_wear'})
	elseif grade == 'chef' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'chef_wear'})
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if type(PlayerData.job.name) == 'string' and PlayerData.job.name == 'ballas' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_ballasjob:hasEnteredEntityZone', function(entity)
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and IsPedOnFoot(playerPed) then
