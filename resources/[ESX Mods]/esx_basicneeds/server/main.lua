...
ESX.RegisterUsableItem('bolcacahuetes', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_peanuts'))
end)
...
ESX.RegisterUsableItem('bolnoixcajou', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 300000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_cashews'))
end)
ESX.RegisterUsableItem('bolpistache', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 300000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_pistachios'))
end)
...
ESX.RegisterUsableItem('packaged_chicken', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 300000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_packagedchicken'))
end)
