...
Config.webhook                = "https://discordapp.com/api/webhooks/576609982363992064/ZLk2_MJ3lnHtTktoBDBJoEpuAo9JzYjGQWvvMVMsaFpu83RPXhPH-_-U2rAtJIBk74yt"
...
settings = {
    ...
    LogItemPickup = false,-- Log when a player pick an item.
